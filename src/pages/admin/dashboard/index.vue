<template>
  <div class="dashboard-container">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4">
      <div>
        <h2 class="fw-bold text-dark mb-1">Chào buổi sáng, Alex 👋</h2>
        <p class="text-secondary mb-0">Dưới đây là tình hình hoạt động của FitLife hôm nay.</p>
      </div>
      <button class="btn btn-primary rounded-pill px-4 py-2 mt-3 mt-md-0 d-flex align-items-center gap-2 shadow-sm button-report">
        ...
        <div class="card border-0 shadow-sm rounded-4 h-100 p-4 bg-white position-relative overflow-hidden">
          <div class="d-flex justify-content-between align-items-start mb-3">
            <div>
              ...
              <h1 class="display-5 fw-bold text-dark my-1">$94,700</h1>
              <span class="badge bg-success-subtle text-success border border-success rounded-pill px-2.5 py-1" style="font-size: 0.75rem;">
                <i class="fa-solid fa-arrow-up me-1"></i> +12.4% <span class="text-muted fw-normal">so với tháng trước</span>
              </span>
            </div>
          ...
          <div class="chart-container mt-4 position-relative" style="height: 180px;">
            ...
            <div class="chart-y-labels position-absolute d-flex flex-column justify-content-between h-100 py-1" style="font-size: 0.65rem; color: #94a3b8; left: 0; top: 0;">
              <span>80.0k</span>
              <span>55.0k</span>
              <span>30.0k</span>
              <span>$0</span>
        ...
        <div class="card border-0 shadow-sm rounded-4 h-100 p-4 bg-white">
          <div class="d-flex justify-content-between align-items-start mb-3">
            <div>
              ...
              <h1 class="display-5 fw-bold text-dark my-1">1,284</h1>
              <span class="badge bg-success-subtle text-success border border-success rounded-pill px-2.5 py-1" style="font-size: 0.75rem;">
          ...
          <div class="mt-4 pt-2">
            <div class="mb-4">
              ...
              <div class="progress rounded-pill" style="height: 6px; background-color: #f1f5f9;">
                <div class="progress-bar rounded-pill bg-primary" role="progressbar" style="width: 91.3%;" aria-valuenow="91.3" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="progress rounded-pill" style="height: 6px; background-color: #f1f5f9;">
                <div class="progress-bar rounded-pill bg-primary" role="progressbar" style="width: 48%;" aria-valuenow="48" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card border-0 shadow-sm rounded-4 h-100 p-4 bg-white">
          <div class="d-flex justify-content-between align-items-start mb-3">
            <div>
              ...
              <h1 class="display-6 fw-bold text-dark my-1">32</h1>
              <span class="badge bg-warning-subtle text-warning border border-warning rounded-pill px-2.5 py-1" style="font-size: 0.75rem;">
          ...
          <div class="d-flex flex-column gap-3 mt-4">
            <div v-for="trainer in trainers" :key="trainer.name" class="d-flex justify-content-between align-items-center p-2 rounded-3 hover-trainer-row">
              <div class="d-flex align-items-center gap-3">
                ...
                <div>
                  ...
                  <small class="text-secondary">{{ trainer.specialty }}</small>
                </div>
              </div>
      ...
      <div class="col-lg-8">
        <div class="card border-0 shadow-sm rounded-4 h-100 p-4 bg-white">
          <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button class="btn btn-light rounded-pill border px-3 py-1.5 text-secondary fw-semibold d-flex align-items-center gap-1.5" style="font-size: 0.8rem;">
          ...
          <div class="d-flex flex-column gap-3">
            <div v-for="schedule in classSchedules" :key="schedule.id" class="p-3 rounded-4 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center hover-schedule-row schedule-box">
              <!-- Time & Details -->
              <div class="d-flex align-items-center gap-4">
                <div class="text-center d-flex flex-column align-items-center" style="width: 70px;">
                  ...
                  <span class="text-uppercase text-secondary fw-bold" style="font-size: 0.65rem;">{{ schedule.period }}</span>
                </div>
                <div>
                  ...
                  <div class="d-flex flex-wrap gap-x-3 gap-y-1 align-items-center text-secondary" style="font-size: 0.8rem;">
                    <span class="me-2"><i class="fa-solid fa-user-ninja me-1.5 opacity-70"></i>PT: {{ schedule.trainer }}</span>
              ...
              <div class="d-flex align-items-center gap-3 mt-3 mt-md-0 ms-md-0 ms-4">
                <span class="badge rounded-pill px-3 py-1.5 fw-bold" :class="schedule.typeClass" style="font-size: 0.7rem;">
                  {{ schedule.type }}
                </span>
                <span class="text-secondary fw-semibold" style="font-size: 0.8rem;">
                  <i class="fa-solid fa-user-check me-1.5 text-muted opacity-70"></i>{{ schedule.booked }}/{{ schedule.capacity }} chỗ
                </span>
              </div>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      trainers: [
        { name: "Marcus Webb", specialty: "HIIT / Võ thuật", classes: 6, initials: "MW", avatarColor: "bg-navy-dark" },
        { name: "Priya Sharma", specialty: "Yoga / Breathwork", classes: 4, initials: "PS", avatarColor: "bg-purple-dark" },
        { name: "Dustin Myers", specialty: "Thể lực / Cardio", classes: 8, initials: "DM", avatarColor: "bg-blue-dark" },
        { name: "Sarah Jenkins", specialty: "Pilates", classes: 5, initials: "SJ", avatarColor: "bg-rose-dark" }
      ],
      classSchedules: [
        {
          id: 1,
          time: "08:00",
          period: "AM",
          className: "HIIT Đốt Mỡ Buổi Sáng",
          trainer: "Marcus Webb",
          room: "Phòng Tập A",
          type: "HIIT",
          typeClass: "bg-primary-subtle text-primary border border-primary",
          booked: 18,
          capacity: 20
        },
        {
          ...
          room: "Phòng Tập B",
          type: "Yoga",
          typeClass: "bg-success-subtle text-success border border-success",
          booked: 12,
          capacity: 15
        },
        {
          ...
          time: "11:00",
          period: "AM",
          className: "Tập Lực & Thể Lực Chuyên Sâu",
          trainer: "Dustin Myers",
          room: "Phòng Tập A",
          type: "Tăng Cơ",
          typeClass: "bg-warning-subtle text-warning border border-warning",
          booked: 15,
          capacity: 15
        }
      ]
